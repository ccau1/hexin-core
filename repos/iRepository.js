...
class RepositoryInterface {
  ...
  async update(query, modelObj) {
    throw new Error('Repo method \'update(query, modelObj)\' needs to be implemented');
  }
  // Return: updated obj
  async updateOne(query, modelObj) {
    throw new Error('Repo method \'updateOne(query, modelObj)\' needs to be implemented');
  }
  // Return: updated obj
  async updateById(id, modelObj) {
    throw new Error('Repo method \'updateById(id, modelObj)\' needs to be implemented');
  }
